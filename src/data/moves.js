export default {
  ...
  charge: {
    ...
    condition: { duration: 2, onBasePowerPriority: 9 },
    boosts: { spd: 1 },
    secondary: null,
    target: "self",
    type: "Electric",
  ...
  collisioncourse: {
    ...
    type: "Fighting",
    contestType: "Tough",
    desc: "Deals 1.3x damage if the move is super effective.",
  ...
  lastrespects: {
    ...
    target: "normal",
    type: "Ghost",
    desc: "Power increases by 50 with each fainted party member.",
  ...
  orderup: {
    ...
    target: "normal",
    type: "Dragon",
    desc: "+1 to stat depending on Tatsugiri color.",
  ...
  revivalblessing: {
    ...
    target: "self",
    type: "Normal",
    desc: "Revives a fainted Pokemon to 50% HP.",
  ...
  saltcure: {
    ...
    condition: { duration: 0, onResidualOrder: 13 },
    secondary: null,
    target: "normal",
    type: "Rock",
    desc: "Deals 1/8 max HP every turn; 1/4 if Steel or Water.",
