export default {
  ...
  aromatherapy: {
      ...
      onHit(target, source, move) {
          ...
          let success = false;
          const allies = [...target.side.pokemon, ...((_a = target.side.allySide) === null || _a === void 0 ? void 0 : _a.pokemon) || []];
  ...
  gigatonhammer: {
      ...
      onDisableMove(pokemon) {
          var _a;
          if (((_a = pokemon.lastMove) === null || _a === void 0 ? void 0 : _a.id) === 'gigatonhammer')
  ...
  gmaxchistrike: {
      ...
      condition: {
          ...
          onStart(target, source, effect) {
              ...
              if (!['costar', 'imposter', 'psychup', 'transform'].includes(effect === null || effect === void 0 ? void 0 : effect.id)) {
  ...
  iceball: {
      ...
      basePowerCallback(pokemon, target, move) {
          ...
          if (iceballData === null || iceballData === void 0 ? void 0 : iceballData.hitCount) {
  ...
  orderup: {
      ...
      onAfterMove(pokemon, target, move) {
          if (!pokemon.volatiles['commanded'] || !move.orderUpBoost)
              return;
  ...
  ragingfury: {
      ...
      onAfterMove(pokemon) {
          var _a;
          if (((_a = pokemon.volatiles['lockedmove']) === null || _a === void 0 ? void 0 : _a.duration) === 1) {
              pokemon.removeVolatile('lockedmove');
          }
      },
      secondary: null,
  ...
  rollout: {
      ...
      basePowerCallback(pokemon, target, move) {
          ...
          if (rolloutData === null || rolloutData === void 0 ? void 0 : rolloutData.hitCount) {
  ...
  substitute: {
      ...
      condition: {
          onStart(target, source, effect) {
              if ((effect === null || effect === void 0 ? void 0 : effect.id) === 'shedtail') {
